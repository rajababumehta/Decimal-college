      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                <span className="font-extrabold text-2xl tracking-tight text-[#0A2F5C] font-serif">
                  DECIMAL
                </span>
                <span className="font-bold text-2xl tracking-tight text-[#D4A017] font-serif">
                  COLLEGE
                </span>
              </div>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={() => onOpenAdmission()}
              className="sm:hidden bg-[#D4A017] text-[#0A2F5C] text-xs font-bold px-3 py-1.5 rounded-md"
            ...
            <button
              ...
              className="p-2 text-slate-700 hover:text-[#0A2F5C] hover:bg-slate-100 rounded-lg transition-colors"
            ...
            <div className="flex flex-col space-y-1">
              {navLinks.map((item) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => handleNavClick(item.id)}
                    className={`flex items-center justify-between px-3.5 py-2.5 rounded-lg font-medium text-sm text-left transition-colors ${
                      isActive 
                        ? 'bg-blue-50 text-[#0A2F5C] font-semibold' 
              ...
              <div className="pt-3 mt-2 border-t border-slate-100 flex flex-col gap-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#0A2F5C] text-white py-2.5 rounded-lg font-bold text-sm shadow-sm"
                >
                ...
                <div className="flex items-center justify-between text-xs text-slate-500 pt-2 px-1">
                  <a href={`tel:${COLLEGE_INFO.phone}`} className="flex items-center gap-1 hover:text-[#0A2F5C]">
                    <Phone className="w-3.5 h-3.5 text-[#D4A017]" />
                    <span>{COLLEGE_INFO.phone}</span>
                  </a>
                  <a href={COLLEGE_INFO.facebookUrl} target="_blank" rel="noreferrer" className="flex items-center gap-1 text-blue-600 font-medium">
                    <span>Facebook</span>
